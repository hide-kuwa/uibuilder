// apps/preview/app/gridsheet2/page.tsx
'use client';
import React from 'react';
import { GridSheetV2 } from '@chizu/registry';
...
export default function Page() {
  return (
    <main className="p-6 space-y-4">
      <h1 className="text-lg font-semibold">GridSheet V2 Preview</h1>
      <GridSheetV2 schema={schema} rows={sample} />
    </main>
  );
}
