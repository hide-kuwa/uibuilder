...
export function NodeInspector({ selectedId, showRounding = true }) {
    ...
    const connected = useMemo(() => data.edges.filter((e) => e.from === selectedId || e.to === selectedId), [data, selectedId]);
    const flagsAgg = connected.reduce((acc, e) => {
    ...
    return (_jsxs("div", { className: "space-y-2 text-sm", children: [_jsx("div", { className: "font-semibold", children: "Node Inspector" }), _jsxs("div", { children: [_jsx("span", { className: "opacity-60", children: "ID\uFF1A" }), meta.id] }), _jsxs("div", { children: [_jsx("span", { className: "opacity-60", children: "Label\uFF1A" }), meta.label ?? '-'] }), _jsxs("div", { children: [_jsx("span", { className: "opacity-60", children: "Kind\uFF1A" }), meta.kind] }), meta.tags?.length ? _jsxs("div", { children: [_jsx("span", { className: "opacity-60", children: "Tags\uFF1A" }), meta.tags.join(', ')] }) : null, showRounding && (_jsxs("div", { className: "pt-2", children: [_jsx("div", { className: "opacity-60 text-xs", children: "Flags" }), _jsxs("ul", { className: "list-disc list-inside", children: [_jsxs("li", { children: ["rounded: ", String(flagsAgg.rounded)] }), _jsxs("li", { children: ["taxAdjust: ", String(flagsAgg.taxAdjust)] }), _jsxs("li", { children: ["manualAdjust: ", String(flagsAgg.manualAdjust)] })] })] }))] }));
}
