...
var BacklinkList_exports = {};
__export(BacklinkList_exports, {
  BacklinkList: () => BacklinkList
});
module.exports = __toCommonJS(BacklinkList_exports);
...
function BacklinkList({ title = "Backlinks", selectedId, onSelect }) {
  ...
  const up = (0, import_react3.useMemo)(() => data && selectedId ? bfsUp(data, selectedId) : [], [data, selectedId]);
  const down = (0, import_react3.useMemo)(() => data && selectedId ? bfsDown(data, selectedId) : [], [data, selectedId]);
