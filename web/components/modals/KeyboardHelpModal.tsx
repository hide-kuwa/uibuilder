  ...
  return (
    <div className="fixed inset-0 grid place-items-center bg-black/50 z-[999]" onClick={onClose}>
      <div
        ...
        className="w-[640px] max-w-[90vw] rounded-2xl p-6 bg-neutral-900 text-neutral-100 shadow-xl"
      ...
      >
        ...
        <ul className="grid grid-cols-2 gap-2 text-sm opacity-90">
          <li><kbd>Alt</kbd> + Drag … Duplicate (snap, ghost)</li>
          <li><kbd>←↑→↓</kbd> … Nudge</li>
          <li><kbd>Shift</kbd> + Nudge … 10px</li>
          <li><kbd>Ctrl/Cmd</kbd> + <kbd>C</kbd> … Copy</li>
          <li><kbd>Ctrl/Cmd</kbd> + <kbd>Shift</kbd> + <kbd>C</kbd> … Copy CSS</li>
          <li><kbd>Ctrl/Cmd</kbd> + <kbd>?</kbd> … This help</li>
